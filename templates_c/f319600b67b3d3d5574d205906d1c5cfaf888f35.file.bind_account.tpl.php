<?php /* Smarty version Smarty-3.1.8, created on 2013-06-15 12:09:42
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
            		...
            		<tr> 
 					...
 					<tr>
					     ...
					     <td height="30"class="grzc_31"><input id="userPassowrd" name="userPassowrd" type="password"  value="" /></td>
		  			</tr>
          				 <td width="105" height="35"></td>
  						  <td height="35" valign="top">
		            ...
		            <tr>
		 			...
		 			<tr>
						<td width="105" height="70" align="right" valign="middle" class="z14"><font class="red">*&nbsp;</font>验证码：</td>
		   				<td height="70">
		                       	  <input name="userEmailMatchCode" type="text" class="sjyz"  value=""/>
		                            <span class="yzm"><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['web_code_web'];?>
