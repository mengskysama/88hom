<?php /* Smarty version Smarty-3.1.8, created on 2013-05-31 12:41:44
            ...
            <div class="mdzc">
           	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
 					...
 					<tr>
  						 ...
  						 <td class="grzc_31"><input name="userRealName" id="userRealName" type="text" maxlength="5" value="" /></td>
  					</tr>
  					<tr>
   						 <td width="140" height="30"></td>
					     <td height="30" valign="top">
					 ...
					 <tr>
  					     <td width="140" height="35" align="right" valign="middle" class="f14 z3"><font class="red">*&nbsp;</font>移动电话：</td>
    					 <td class="grzc_31"> 
    						<select name="ddlPhoneType" id="ddlPhoneType" class="select2">
 						    ...
 						    <option value="2">小灵通</option> 						    
   							...
   							<input id="txtUserPhone" name="txtUserPhone" type="text" value="" style=" float:left; margin-left:15px;width:200px;height:25px;"/>
   						 </td>
 					 </tr>
 					 <tr>
     						<td width="140" height="30"></td>
  					 ...
  					 <tr>
   							...
   							<td class="grzc_31"><input name="userTel" id="userTel" type="text"  value="" /></td>
 					 </tr>
 					 <tr>
  							<td width="140" height="30"></td>
		 					<td height="30" valign="top">
 					...
 					<tr>
    						...
    						<td class="grzc_31"><input name="userEmail" id="userEmail" type="text"  value="" /></td>
 					</tr>
 					<tr>
  					...
  					<tr>
 						   <td height="55" colspan="2" align="right" valign="middle" class="z14">
                           		<div class="dlmm"><input name="agent_reg_confirm" id="agent_reg_confirm" type="button" class="mddl" id="button2" value="立即注册" /></div>
                           </td>
	    		  </tr>
	</table>
