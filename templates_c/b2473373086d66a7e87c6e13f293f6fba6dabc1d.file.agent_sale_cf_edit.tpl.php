<?php /* Smarty version Smarty-3.1.8, created on 2013-07-15 22:56:00
         compiled from "E:/workplace/phpprojects/88hom/templates\ucenter\agent_sale_cf_edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:612151e40087730531-52504448%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b2473373086d66a7e87c6e13f293f6fba6dabc1d' => 
    array (
      0 => 'E:/workplace/phpprojects/88hom/templates\\ucenter\\agent_sale_cf_edit.tpl',
      1 => 1373900156,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '612151e40087730531-52504448',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_51e40087952223_36213811',
  'variables' => 
  array (
    'cfg' => 0,
    'jsFiles' => 0,
...
<?php if ($_valid && !is_callable('content_51e40087952223_36213811')) {function content_51e40087952223_36213811($_smarty_tpl) {?>﻿<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" /></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="middle" class="p25 grzc_32"><input id="factorySellPrice" name="factorySellPrice" type="text" value="<?php echo $_smarty_tpl->tpl_vars['factorySellPrice']->value;?>
...
" /></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="middle" class="p25">
			    	<label><input id="" name="factoryPayInfo" type="radio" <?php if ($_smarty_tpl->tpl_vars['factoryPayInfo']->value==1){?> checked="checked" <?php }?> value="1"/> 国有土地证</label>     
			      	<label> <input id="" name="factoryPayInfo" type="radio" <?php if ($_smarty_tpl->tpl_vars['factoryPayInfo']->value==2){?> checked="checked" <?php }?> value="2" /> 集体土地证  </label>    
			    </td>
			  </tr>
			  <tr>
...
" />
			  ...
			  <tr>
			    ...
			    <td align="left" valign="middle" class="p25 grzc_32"><input id="factoryBuildYear" name="factoryBuildYear" type="text" maxlength="4" value="<?php echo $_smarty_tpl->tpl_vars['factoryBuildYear']->value;?>
		...
		<table width="732" border="0" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF">
		  <tr>
		    ...
		    <td width="611" align="left" valign="middle" class="p25 grzc_31">
		    	<input name="factoryPrivateNumber" type="text"  value="<?php echo $_smarty_tpl->tpl_vars['factoryPrivateNumber']->value;?>
" />
		    </td>
		  </tr>
		  <tr>
