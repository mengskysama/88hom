<?php /* Smarty version Smarty-3.1.8, created on 2013-07-15 09:57:38
         compiled from "E:/workspace/projects/88hom/templates\ucenter\estate_input.tpl" */ ?>
<?php /*%%SmartyHeaderCode:450451e35712b9ad78-98120605%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1d91d4ceec52b7d81df9724c52aa2c1843b9237' => 
    array (
      0 => 'E:/workspace/projects/88hom/templates\\ucenter\\estate_input.tpl',
      1 => 1373851191,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '450451e35712b9ad78-98120605',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51e35712cc15d4_10951425',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51e35712cc15d4_10951425')) {function content_51e35712cc15d4_10951425($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
    	...
    	initPicUp2('1','<?php echo $_smarty_tpl->tpl_vars['timestamp']->value;?>
...
');
        initPicUp2('3','<?php echo $_smarty_tpl->tpl_vars['timestamp']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['cfg']->value['file_path_upload'];?>
','<?php echo $_smarty_tpl->tpl_vars['cfg']->value['web_path'];?>
','<?php echo $_smarty_tpl->tpl_vars['cfg']->value['web_common'];?>
...
.navbg{ background:url(<?php echo $_smarty_tpl->tpl_vars['cfg']->value['web_images'];?>
ucenter/navbg.gif) no-repeat; width:95px; height:33px; float:left; color:#fff; font-size:12px; font-weight:bold; line-height:33px; text-align:center;}
...
.subnavwz{ background:url(<?php echo $_smarty_tpl->tpl_vars['cfg']->value['web_images'];?>
ucenter/nav-tb.gif) no-repeat left center ; float:left; padding-left:25px; margin-left:10px; color:#2b4896; font-size:13px; font-weight:bold; display:inline;}
.subnavr{ border-bottom:1px #b0bebe solid; float:left; height:30px; width:875px;}
.ts{ float:right; margin-right:10px; display:inline;}
.tswz{ background:url(<?php echo $_smarty_tpl->tpl_vars['cfg']->value['web_images'];?>
ucenter/ts-tb.gif) no-repeat left center; float:left; font-size:12px; padding-left:25px; line-height:30px; color:#000; text-align:left;}
...
.foot-btn .tj{ background:url(<?php echo $_smarty_tpl->tpl_vars['cfg']->value['web_images'];?>
ucenter/tj-btn.gif) no-repeat; width:55px; height:30px; float:left; color:#483700; line-height:30px; text-align:center; border:0px;}
.foot-btn .qx{ background:url(<?php echo $_smarty_tpl->tpl_vars['cfg']->value['web_images'];?>
ucenter/qx-btn.gif) no-repeat; width:57px; height:30px; float:left; color:#1e313f; line-height:30px; text-align:center; border:0px; margin-left:15px;}
</style>
<body>
<div class="all">
	<div class="nav">
...
<script>
<?php echo $_smarty_tpl->tpl_vars['err_msg_submit']->value;?>
