<?php /* Smarty version Smarty-3.1.8, created on 2013-07-19 12:35:19
         compiled from "E:/workspace/projects/88hom/templates\ucenter\user_lease_prop_agent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3120751e8b5fbea4967-73386592%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5ce1f49c27058695a29e3d5dec3c5fed13a27a2' => 
    array (
      0 => 'E:/workspace/projects/88hom/templates\\ucenter\\user_lease_prop_agent.tpl',
      1 => 1374207624,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3120751e8b5fbea4967-73386592',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_51e8b5fc00bca5_96713395',
  'variables' => 
  array (
    'cfg' => 0,
    'jsFiles' => 0,
...
<?php if ($_valid && !is_callable('content_51e8b5fc00bca5_96713395')) {function content_51e8b5fc00bca5_96713395($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
function checkRentPrice(){
    ...
    var value=document.getElementById("propPrice").value;
    if(trim(value) == ''){
		alert("请填写租金");
		$("#propPrice").focus();
        return false;
...
"/>
          <input id="txType" name="txType" type="hidden" value="2"/>
...
" type="text" maxlength="50" onkeyup="textCounter(document.getElementById('estName'),document.getElementById('estNameAlert'),25);" /> 还可写<span id="estNameAlert"><font class="red">25</font></span>个汉字 </td>
		  ...
		  <tr>
		    <td width="120" height="42" align="center" valign="middle" bgcolor="#f7f6f1" class="z14"><font class="red">*</font>&nbsp;目标租金</td>
		    <td valign="middle" class="grzc_33 p5"><input id="propPrice" name="propPrice" value="<?php echo $_smarty_tpl->tpl_vars['propPrice']->value;?>
" type="text" /> 元/月</td>
