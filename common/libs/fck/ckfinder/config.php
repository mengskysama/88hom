...
*/
if($_SERVER ['SERVER_NAME']=='localhost'||$_SERVER ['SERVER_NAME']=='127.0.0.1'||$_SERVER ['SERVER_NAME']=='192.168.0.27'){
	$baseUrl = 'http://'.$_SERVER ['SERVER_NAME'].'/g-cre/userfiles/';
}else{
	$baseUrl = 'http://'.$_SERVER ['SERVER_NAME'].'/userfiles/';
}
...
//$baseDir = resolveUrl($baseUrl);
if($_SERVER ['SERVER_NAME']=='localhost'||$_SERVER ['SERVER_NAME']=='127.0.0.1'||$_SERVER ['SERVER_NAME']=='192.168.0.27'){
	$baseDir = resolveUrl('/g-cre/userfiles/');
}else{
	$baseDir = resolveUrl('/userfiles/');
}
