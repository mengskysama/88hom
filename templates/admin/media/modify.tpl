...
$(document).ready(function() {
	$("#file_upload").uploadify({
	    ...
	    'fileTypeExts' : '*.doc; *.docx; *.xls; *.xlsx; *.ppt; *.pptx; *.ods; *.odt; *.pdf; *.rar; *.zip; *.txt',//可上传的文件类型
		...
		'swf':'<!--{$cfg.web_common}-->uploadify/uploadify.swf',//所需要的flash文件
	 	'uploader':'<!--{$cfg.web_path}-->common/libs/uploadify/uploadify_files.php',//所需要的flash文件
...
<form id="modifyForm" name="modifyForm" action="action.php?action=modify" method="post" onsubmit="return exeAdminMediaModify();">
	...
	<table cellspacing="0" cellpadding="0" >
		<tr>
			<td width="70">标题：</td><td><input class="input" type="text" id="title" name="title" value="<!--{$mediaDetail.title}-->" style="width: 300px;"/></td>
		</tr>
		<tr>
			<td>外观图：</td>
			<td>
			<font color="red">注意：上传文件大小请不要超过10M！</font><br/><br/>
			...
			<div id="showImg">已传文件：<!--{$mediaDetail.file_name}--></div>
			</td>
		</tr>
		<tr>
