...
<form id="releaseForm" name="releaseForm" action="action.php?action=complexImcpRelease" method="post" onsubmit="return exeAdminComplexImcpRelease();">
	<table cellspacing="0" cellpadding="0" >
		<tr>
			<td width="150">中介公司名称【短写】：</td><td><input class="input" type="text" id="imcpShortName" name="imcpShortName" style="width: 300px;"/></td>
		</tr> 
		<tr>
			<td>中介公司名称【全称】：</td><td><input class="input" type="text" id="imcpName" name="imcpName" style="width: 300px;"/></td>
		</tr> 
		<tr>
			<td>中介公司地址：</td><td><input class="input" type="text" id="imcpAddress" name="imcpAddress" style="width: 300px;"/></td>
		</tr> 
		<tr>
			<td>中介公司网址：</td><td><input class="input" type="text" id="imcpWebSite" name="imcpWebSite" style="width: 300px;"/></td>
		</tr> 
		<tr>
			<td>中介公司LOGO：</td>
			<td>
			...
			<div id="showImg" style="float: left;clear: both;"></div>
			</td>
		</tr>
		<tr>
