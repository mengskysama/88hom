...
<div class="title_panel">
	...
	<table cellspacing="0" cellpadding="0" >
		...
		<tr>
			<td>租金：</td>
			<td><!--{$houseDetail.houseSellPrice}-->元/月</td>
		</tr>
		<tr>
			<td>户型：</td>
			<td>
		...
		<tr>
			<td>租赁方式：</td>
			<td>
			<!--{if $houseDetail.houseRentType=='整租'}-->
			<!--{$houseDetail.houseRentType}-->
			<!--{else if $houseDetail.houseRentType=='合租'}-->
			<!--{$houseDetail.houseRentType}-->
			[合租形式：<!--{$houseDetail.houseRentRoomType}-->-<!--{$houseDetail.houseRentDetail}-->]
			<!--{/if}-->
			</td>
		</tr>
		<tr>
			<td>支付方式：</td>
			<td>
			<!--{if $houseDetail.housePayment=='押付'}-->
			<!--{$houseDetail.housePayment}-->
			[押付形式：押<!--{$houseDetail.housePayDetailY}-->-付<!--{$houseDetail.housePayDetailF}-->]
			<!--{else if $houseDetail.housePayment=='面议'}-->
			<!--{$houseDetail.housePayment}-->
			<!--{/if}-->
			</td>
		</tr>
		<tr>
			<td>出租面积：</td>
			<td>
			<!--{if $houseDetail.houseRentArea>0}-->
			<!--{$houseDetail.houseRentArea}-->平方米
			<!--{else}-->
			--
			<!--{/if}-->
			</td>
