...
<div class="title_panel">
	<div class="title">家居卖场添加</div>
</div>
	<form method="post" action="furnitureStore_manager.php?action=doAdd">
	<table cellspacing="0" cellpadding="0" >
		...
		<tr ><td width="100">名称：</td><td><input class="input" type="text" name="name" value=""/><font color="red" >*</font></td></tr>
		<tr ><td width="100">地址：</td><td><input class="input" type="text" name="address" value=""/></td></tr>
		<tr ><td width="100">电话：</td><td><input class="input" type="text" name="phone" value=""/></td></tr>
		<tr ><td width="100">营业时间：</td><td><input class="input" type="text" name="businessTime" value=""/></td></tr>
		<tr ><td width="100">排序号：</td><td><input class="input" type="text" name="orderNum" value="1"/>(正整数)</td></tr>
		<tr >
			<td width="100">开启：</td>
			<td>
