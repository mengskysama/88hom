				...
				'onUploadSuccess' : function(file, data, response) {
		    		...
		    		if(response==true && obj[0].result==1){
		        		...
		        		var html='<span style="float:left;margin:5px;line-height:25px;"><a target="_blank" href="<!--{$cfg.web_url}-->uploads/'+obj[0].path+'">'
		        				...
		        				+'</a><br/>名称：<input type="text" name="name[]" value=""/><br/>链接：<input type="text" name="url[]" value=""/>(可选，格式：http://www.baidu.com)<br/>序号：<input type="text" name="orderNum[]" value="1"/>(正整数)<input type="hidden" name="path[]" value="'
...
<div class="title_panel">
	...
	<form method="post" action="furniture_brand_manager.php?action=doAdd">
