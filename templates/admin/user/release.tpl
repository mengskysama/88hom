...
<form id="releaseForm" name="releaseForm" action="action.php?action=release" method="post" onsubmit="return exeAdminWebUserRelease();">
	<table cellspacing="0" cellpadding="0" >
		<tr>
			<td width="70">用户名：</td><td><input class="input" type="text" id="username" name="username" /></td>
		</tr> 
		<tr>
			<td>姓名：</td><td><input class="input" type="text" id="uname" name="uname" /></td>
		</tr>
		<tr>
			<td>密码：</td><td><input class="input" type="password" id="password" name="password" value="123456"/>新建用户，密码默认为123456</td>
		</tr>
		<tr>
			<td>确认密码：</td><td><input class="input" type="password" id="password_" name="password_" value="123456"/></td>
		</tr>
		<tr>
			<td>性别：</td><td><input type="radio" name="sex" value="1" checked="checked">男</input> <input type="radio" name="sex" value="0">女</input></td>
		</tr>
		<tr>
			<td>部门：</td><td><input class="input" type="text" id="dept" name="dept" /></td>
		</tr>
		<tr>
			<td>联系电话：</td><td><input class="input" type="text" id="tel" name="tel" /></td>
		</tr>
		<tr>
			<td>地址：</td><td><input class="input" type="text" id="address" name="address" /></td>
		</tr>
		<tr>
			<td>个人相片：</td>
			<td>
			<font color="red">注意：请上传尺寸为200(宽)*300(高)的图片,超过尺寸大小将自动等比例缩放至200(宽)*300(高)！</font><br/><br/>
