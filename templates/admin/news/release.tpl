...
<form id="releaseForm" name="releaseForm" action="action.php?action=release" method="post" onsubmit="return exeAdminInfoRelease();">
	...
	<table cellspacing="0" cellpadding="0" >
		...
		<tr>
			<td>关键字：</td><td><input class="input" type="text" id="keyword" name="keyword"/></td>
		</tr>
		<tr>
			<td>信息类别：</td><td>
				<select id="typeId" name="typeId" onchange="exeAdminChangeInfoType();">
					<option value="">请选择信息类别</option>
					<!--{html_options options=$infoTypeList}-->
				</select>
				<span id="span_typeId" style="display: none;"><a id="a_typeId" href="">返回上一级类别</a></span>
			</td>
		</tr>
		<tr>
			<td>外观图：</td>
			<td>
			<font color="red">注意：请上传尺寸为270(宽)*188(高)的图片,超过尺寸大小将自动等比例缩放至270(宽)*188(高)！</font><br/><br/>
