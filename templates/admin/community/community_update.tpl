...
<script type="text/javascript">
	$(document).ready(function(){
		//初始化区域
		$('#txtCity').val(C[<!--{$community.communityProvince}-->][<!--{$community.communityCity}-->]);
		$('#txtDistrict').val(D[<!--{$community.communityProvince}-->][<!--{$community.communityCity}-->][<!--{$community.communityDistrict}-->]);
		$('#txtComareas').val(A[<!--{$community.communityProvince}-->][<!--{$community.communityCity}-->][<!--{$community.communityDistrict}-->][<!--{$community.communityArea}-->]);
...
<div class="title_panel">
	<div class="title">小区修改</div>
</div>
	<form method="post" action="community_manager.php?action=doUpdate">
	<input type="hidden" name="communityId" value="<!--{$community.communityId}-->"/>
	<table cellspacing="0" cellpadding="0" >
		<tr ><td width="100">名称：</td><td><input  maxlength="255" class="input_long" type="text" name="communityName" value="<!--{$community.communityName}-->"/><font color="red">*</font></td></tr>
                    ...
                    <th style="width: 360px;" align="left">
                        ...
                        <div style="position: relative; z-index: 10000;" >
                            ...
                            <input type="text" class="input_cs" autocomplete="off" id="txtComareas" name="txtComareas" readonly="readonly"
                             ...
                             <!--省，市，区域，片区下标,以"-"隔开 -->
							<input type="hidden" name="areaIndex"	id="areaIndex" value="<!--{$community.communityProvince}-->-<!--{$community.communityCity}-->-<!--{$community.communityDistrict}-->-<!--{$community.communityArea}-->"/>	
		...
		<tr ><td width="100">物业类型：</td>
			<td>
				...
				<input name="communityIsVillaType" value="1" type="checkbox" checked="checked"/>别墅
				<!--{else}-->
				<input name="communityIsVillaType" value="1" type="checkbox"/>别墅
				<!--{/if}-->
				 <font color="red">*</font>
			</td>
		</tr>
		<tr ><td width="100">建筑类型：</td><td><input  maxlength="255" class="input" type="text" name="communityBuildType" value="<!--{$community.communityBuildType}-->"/></td></tr>
		<tr ><td width="100" rowspan="2">基本信息：</td>
			<td>
				<span style="float:left;width:200px;">参考均价:<input class="input_short" type="text" name="communityRefPrice" value="<!--{$community.communityRefPrice}-->"/>元 </span>
				<span style="float:left;width:200px;">主力户型:<input maxlength="255"  class="input_short" type="text" name="communityMainHouseModel" value="<!--{$community.communityMainHouseModel}-->"/></span> 
				<span style="float:left;width:200px;">物业费:<input class="input_short" type="text" name="communityManagerFee" value="<!--{$community.communityManagerFee}-->"/>元/平米</span> 
				<span style="float:left;width:200px;">产权年限:<input class="input_short" type="text" name="communityRight" value="<!--{$community.communityRight}-->"/>年</span>
				<span style="float:left;width:200px;">停车位:<input maxlength="255"  class="input_short" type="text" name="communityParkingSpace" value="<!--{$community.communityParkingSpace}-->"/></span>
			</td>
		</tr>
		<tr >
			<td>
				<span style="float:left;width:200px;">总户数:<input maxlength="255"  class="input_short" type="text" name="communityHouseholds" value="<!--{$community.communityHouseholds}-->"/></span>  	
				<span style="float:left;width:200px;">装修状况:<input  maxlength="255" class="input_short" type="text" name="communityFitmentStatus" value="<!--{$community.communityFitmentStatus}-->"/></span> 
				<span style="float:left;width:200px;">容积率:<input class="input_short" type="text" name="communityVolRate" value="<!--{$community.communityVolRate}-->"/>%</span> 
				<span style="float:left;width:200px;">绿化率:<input class="input_short" type="text" name="communityGreenRate" value="<!--{$community.communityGreenRate}-->"/>%</span> 
				<span style="float:left;width:200px;">建筑面积:<input class="input_short" type="text" name="communityBuildArea" value="<!--{$community.communityBuildArea}-->"/>平米</span> 
				<span style="float:left;width:200px;">占地面积:<input class="input_short" type="text" name="communityLandArea" value="<!--{$community.communityLandArea}-->"/>平米</span> 	
			</td>
		</tr>
		<tr ><td width="100">小区地址：</td><td><input maxlength="255"  class="input_long" type="text" name="communityAddress" value="<!--{$community.communityAddress}-->"/></td></tr>
		<tr ><td width="100">地理经纬度：</td>
			<td>
				<input class="input_long" type="text" name="communityMap" value="<!--{$community.communityMapX}-->,<!--{$community.communityMapY}-->"/><font color="red">*</font>(如 <font color="red">123.123,123.123</font>)逗号隔开
			</td>
		</tr>
		<tr ><td width="100">项目特色：</td><td><input maxlength="255"  class="input_long" type="text" name="communityProjectFeatures" value="<!--{$community.communityProjectFeatures}-->"/></td></tr>
		<tr ><td width="100">物业公司：</td><td><input  maxlength="255" class="input_long" type="text" name="communityCompany" value="<!--{$community.communityCompany}-->"/></td></tr>
		<tr ><td width="100">物业公司地址：</td><td><input maxlength="255"  class="input_long" type="text" name="communityCompanyAddress" value="<!--{$community.communityCompanyAddress}-->"/></td></tr>
		<tr ><td width="100">开发商：</td><td><input maxlength="255"  class="input_long" type="text" name="communityDevCompany" value="<!--{$community.communityDevCompany}-->"/></td></tr>
		<tr ><td width="100">开发商地址：</td><td><input  maxlength="255" class="input_long" type="text" name="communityDevCompanyAddress" value="<!--{$community.communityDevCompanyAddress}-->"/></td></tr>
		<tr ><td width="100">售楼地址：</td><td><input  maxlength="255" class="input_long" type="text" name="communitySellHouseAddress" value="<!--{$community.communitySellHouseAddress}-->"/></td></tr>
		...
		<tr ><td width="100">控制设置：</td>
			<td>
				开启：<!--{if $community.communityState eq 1}-->
						<input type="radio" name="communityState" checked="checked" value="1"/>是  <input type="radio" name="communityState"  value="0"/>否
					  <!--{else}-->	
					  	<input type="radio" name="communityState"  value="1"/>是  <input type="radio" name="communityState"  checked="checked"value="0"/>否
					  <!--{/if}-->
				推荐：<!--{if $community.communityIsSuggest eq 1}-->
					  <input type="radio" name="communityIsSuggest" checked="checked" value="1"/>是  <input type="radio" name="communityIsSuggest"  value="0"/>否 
					   <!--{else}-->
					   <input type="radio" name="communityIsSuggest"  value="1"/>是  <input type="radio" name="communityIsSuggest" checked="checked" value="0"/>否 
					   <!--{/if}-->	
				排序号：<input class="input_short" type="text" name="communityOrderNum" value="<!--{$community.communityOrderNum}-->"/>(正整数)
			</td>
		</tr>
