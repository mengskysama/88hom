...
<script type="text/javascript">
	...
	function check(){
		...
		if($('select[name="picInfo"]').val()=='')
		{
			alert('请选择图片类别！');
			$('select[name="picInfo"]').focus();
			return false;
		}
...
<div class="title_panel">
	<div class="title">小区图片更新</div>
</div>
	<form method="post" action="community_manager.php?action=pic&subAction=doUpdate">
	...
	<table cellspacing="0" cellpadding="0" >
		<tr ><td width="100">图片信息：</td><td width="250"><input class="input" type="text" name="picInfo" value="<!--{$pic.picInfo}-->"/><font color="red">*</font></td>
			<td rowspan="5" id="showImg">
