...
<div class="title_panel">
	...
	<form method="post" action="type_manager.php?action=doUpdate">
		<input type="hidden" name="adtypeId" value="<!--{$adType.adtypeId}-->"/>
	<table cellspacing="0" cellpadding="0" >
		<tr ><td>类别名称：</td><td><input class="input" type="text" name="adtypeName" value="<!--{$adType.adtypeName}-->"/></td></tr>
		<tr ><td>类别码：</td><td><input class="input" type="text" name="adtypeKey" value="<!--{$adType.adtypeKey}-->"/></td></tr>
		<tr ><td>是否开启：</td>
		<td>
			<!--{if $adType.adtypeState eq 1}-->
