		...
		<div class="body">
			...
			<div class="right">
				...
				<div class="location">
					...
					<div class="l2">
						<a href="<!--{$cfg.web_url}-->index.htm">星河首页</a> > <a href="<!--{$cfg.web_url}-->news/index.htm">新闻中心</a> > <a href="<!--{$cfg.web_url}-->news/index.htm">企业动态</a> > <!--{$infoDetail.NewsTitle}--> 
					</div>
				</div>
				...
				<div class="news">
					<div class="news_detail">
						<div class="title">
							...
							<div id="newsAddTime" class="b">日期：<!--{$infoDetail.AddTime}--></div>
						</div>
						<div class="content">
