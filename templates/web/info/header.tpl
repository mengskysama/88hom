	<div class="layer_content_1">
		<div class="wrap_header">
			<div class="logo">
				<div class="a">
					<a href="<!--{$cfg.web_url}-->furniture"><img src="<!--{$cfg.web_images}-->web/logo.png"></a>
				</div>
				<div class="b">
					<a class="l" href="#">二手房</a> <a href="#">[购房]</a> <a href="#">[租房]</a><br/>
					<a class="l" href="<!--{$cfg.web_url}-->furniture">家居</a> <a href="#">[装修]</a> <a href="#">[装饰]</a><br/>
					<a class="l" href="#">社区</a>
				</div>
			</div>
			<div class="info">
				<div class="a">
					<div class="a1">
						<a href="javascript:void(0);">新房</a><a href="javascript:void(0);">二手房</a><a href="#">租房</a><a  href="<!--{$cfg.web_url}-->furniture">家居</a>
					</div>
					<div class="a2">
						<div class="a21">
							<div class="a211">
								<a class="current" href="#">广告投放</a> | <a href="#">二手房</a> | <a href="<!--{$cfg.web_url}-->furniture">家居</a> | <a href="#">社区</a>
								<!--返回顶部锚链-->
								<a name="top"></a>
							</div>
							<div class="a212">
				...
				<div class="c">
					...
					<div class="c3">
						<a href="#">设计修饰</a>
						<a href="#">促销团购</a><br/>
						<a href="<!--{$cfg.web_url}-->furniture/store.php">家具卖场</a>
						<a href="<!--{$cfg.web_url}-->furniture/info.php?infoType=7|702">装修指南</a>
					</div>
					<div class="s"></div>
					<div class="c4">
						<a href="#">业主论坛</a>
