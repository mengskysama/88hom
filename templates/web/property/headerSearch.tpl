...
$(function() {
	function search( search ) {
		...
		message=$.base64.btoa(search);
		location.href=domain+'property/search.php?p='+p+'&c='+c+'&search='+search;
	}
	$( "#search" ).autocomplete({
...
function doSearch(){
	...
	//alert(domain+'property/search.php?p='+p+'&c='+c+'&d='+searchArea+'&a=&t='+searchBuildType+'&pr='+searchPrice+'&search='+search);
	location.href=domain+'property/search.php?p='+p+'&c='+c+'&d='+searchArea+'&a=&t='+searchBuildType+'&pr='+searchPrice+'&search='+search;
}
</script>
<!--主体头部面板-->
		...
		<div class="wrap_header">
			...
			<div class="info">
				...
				<div class="b">
					<div class="b1">
					<div class="ui-widget">
					<span class="b11"><input type="text" id="search" name="search" value="<!--{$search}-->" onmousedown="exeWebPropertySearchDown(this.value);" onblur="exeWebPropertySearchOut(this.value);"/></span>
					...
					<div class="b2">
						<select id="searchArea" name="searchArea">
							<!--{html_options options=$searchArea selected=$d}-->
						</select>
						...
						<select id="searchPrice" name="searchPrice">
							<!--{html_options options=$searchPrice selected=$pr}-->
						</select>
						<span class="b21">
							<a href="#">[地图找房]</a>
						</span>
