...
<title>我要<!--{if $cType==1}-->找二手<!--{elseif $cType==2}-->租房<!--{/if}-->_我的<!--{if $cType==1}-->找<!--{elseif $cType==2}-->租<!--{/if}-->房条件_用户中心_房不剩房</title>
<!--{$jsFiles}-->
<!--{$cssFiles}-->
</head>
<body>
...
<!--{include file="$ucenter_user_left_menu"}-->
    <div class="qg_r">
    	<p>你的位置： <a href="ucenter_user.php">我的房不剩房<a> </a> > <a href="user_wanted.php?wType=<!--{$cType}-->">我要<!--{if $cType==1}-->买<!--{elseif $cType==2}-->租<!--{/if}-->房</a> > <a href="user_search_criteria.php?cType=<!--{$cType}-->">我的<!--{if $cType==1}-->找<!--{elseif $cType==2}-->租<!--{/if}-->房条件</a> <!--{if $cType==1}-->> <a href="javascript:void(0);"></a>我的二手找房条件<!--{/if}--></p>
        <div class="qg_bs">
			...
			<ul style="width:292px; font-size:14px; font-weight:bolder;">
   			 	<li><a href="my_search_criteria.php?cType=<!--{$cType}-->">我要<!--{if $cType==1}-->找<!--{elseif $cType==2}-->租<!--{/if}-->新房</a></li>
    		    <li><a href="javascript:void(0);">我要<!--{if $cType==1}-->找<!--{elseif $cType==2}-->租<!--{/if}-->二手房</a></li>
   		  </ul>
          </div>
          <!--{/if}-->
        </div>
        <div class="qgxq2">
       	  ...
       	  <div class="other" id="div_err_msg">  	  	 
       	   ...
       	   <form id="do_search_criteria" action="do_search_criteria.php?action=release" method="post">
       	    ...
       	    <input type="hidden" id="hand" name="hand" value="2" />
