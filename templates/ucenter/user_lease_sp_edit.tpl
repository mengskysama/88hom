...
<div class="qg_main">
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25">
    	<label><input id="" name="shopsIncludFee" type="radio" value="1" <!--{if $shopsIncludFee eq 1 }--> checked="checked" <!--{/if}-->/> 是</label>     
      	<label> <input id="" name="shopsIncludFee" type="radio" value="2" <!--{if $shopsIncludFee eq 2 }--> checked="checked" <!--{/if}-->/> 否</label>   
    </td>
  </tr>
  <tr>
