...
<div class="qg_main">
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_36"><input name="" type="text"  value="" /> 室 <input name="" type="text"  value="" /> 厅 <input name="" type="text"  value="" /> 卫 <input name="" type="text"  value="" /> 厨 <input name="" type="text"  value="" /> 阳台</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25" style="line-height:26px;">
    	 <span><label><input name="" type="checkbox" value="" / > 煤气/天然气</label></span>
          <span><label><input name="" type="checkbox" value="" / > 暖气 </label></span>
         <span> <label><input name="" type="checkbox" value="" / > 电梯 </label></span>
          <span><label><input name="" type="checkbox" value="" / > 车位/车库</label></span>
          <span><label><input name="" type="checkbox" value="" / > 储藏室/地下室</label></span>
          <span><label><input name="" type="checkbox" value="" / > 花园/小院</label></span>
         <span><label> <input name="" type="checkbox" value="" / > 露台</label></span>
         <span> <label><input name="" type="checkbox" value="" / > 阁楼</label></span>
