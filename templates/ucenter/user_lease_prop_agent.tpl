...
<div class="qg_main">
    ...
    <div class="qg_r">
        ...
        <div class="qgxq">
       		 <b class="wyqg f14 z3"><img src="<!--{$cfg.web_images}-->ucenter/qg_32.jpg"> 我要出租</b>
        ...
        <div class="qgxq2">
		  ...
		  <tr>
		    ...
		    <td valign="middle" class="grzc_33 p5"><input id="propPrice" name="propPrice" value="<!--{$propPrice}-->" type="text" /> 元/月</td>
