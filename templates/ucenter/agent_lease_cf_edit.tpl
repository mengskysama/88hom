          ...
          <div class="bs_tx">
			...
			<table width="732" border="0" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF">
			  ...
			  <tr>
			    ...
			    <td align="left" valign="middle" class="p25"> 
			    	<label><input id="" name="factoryIncludFee" type="radio" <!--{if $factoryIncludFee eq 1 }--> checked="checked" <!--{/if}--> value="1" onclick="changeIncludeFee(1,'factoryProFee');" /> 是</label>     
			      	<label> <input id="" name="factoryIncludFee" type="radio" <!--{if $factoryIncludFee eq 2 }--> checked="checked" <!--{/if}--> value="2" onclick="changeIncludeFee(2,'factoryProFee');" /> 否</label>    
			        </td>
			  </tr>
			  <!--{if $factoryIncludFee eq 2 }-->
			  <tr id="tr_prop_fee">
			  <!--{else}-->
