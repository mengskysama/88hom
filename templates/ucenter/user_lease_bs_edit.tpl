...
<div class="qg_main">
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_33"><input id="villaRentPrice" name="villaRentPrice" type="text" onblur="checkRentPrice();" value="<!--{$villaRentPrice}-->" /> <font class="z3">元/月</font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_33"><input id="villaBuildArea" name="villaBuildArea" type="text" value="<!--{$villaBuildArea}-->" maxlength="8" onblur="CheckRentArea();"/> <font class="z3">平方米</font> 请填写产权面积，如将赠送面积算在内，视为违规。</td>
  </tr>
  <tr>
