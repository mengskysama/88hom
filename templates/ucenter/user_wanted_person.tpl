...
<title>直接发布_我要求<!--{if $wType==1}-->购<!--{elseif $wType==2}-->租<!--{/if}-->_用户中心_房不剩房</title>
<!--{$jsFiles}-->
<!--{$cssFiles}-->
</head>
...
<div class="qg_main">
    ...
    <div class="qg_r">
    	<p>你的位置： <a href="ucenter_user.php"> 我的房不剩房</a> > <a href="user_wanted.php?wType=<!--{$wType}-->">我要<!--{if $wType==1}-->买<!--{elseif $wType==2}-->租<!--{/if}-->房</a> > <a href="user_wanted.php?wType=<!--{$wType}-->"> 我要求<!--{if $wType==1}-->购<!--{elseif $wType==2}-->租<!--{/if}--> ><a href="javascript:void(0);"> 直接发布</a></p>
        <div class="qgxq">
        ...
        <div class="qgxq2">
          ...
          <div class="qgbg">
           <form id="do_user_wanted" action="do_user_wanted.php?action=release" method="post">
       	    ...
       	    <input type="hidden" id="isIntermediary" name="isIntermediary" value="2" />
  ...
  <tr>
    ...
    <td valign="middle" class="p5">
      <textarea class="bdqy1" rows="7" cols="100" name="content" id="content" ></textarea>
      </td>
  </tr>
   <tr>
    <td height="25">&nbsp;</td>
  ...
  <tr>
    ...
    <td width="175" class="grzc_33 p5"><input name="contact" type="text" id="contact"  value="" /> </td>
  </tr>
  <tr>
    <td height="42" align="center" valign="middle" bgcolor="#f7f6f1" class="z14" ><font class="red">*</font>手机号码</td>
    <td width="175" class="grzc_33 p5"><input name="mobile" type="text" id="mobile"  value="" /> </td>
    <td>（通过认证才能发布房源）</td>
  </tr>
  <tr>
