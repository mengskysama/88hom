 ...
 <dl>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25">
    	<label><input id="" name="radio" type="radio" value="纯写字楼" checked="checked" /> 纯写字楼</label>     
      	<label> <input id="" name="radio" type="radio" value="商住楼" /> 商住楼</label>
        <label> <input id="" name="radio" type="radio" value="商业综合体楼" /> 商业综合体楼</label>
         <label> <input id="" name="radio" type="radio" value="酒店写字楼" /> 酒店写字楼</label>
    </td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1"> <font class="red">*</font> 单    价</td>
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> 元/平米</td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1"><font class="red">*</font>物 业 费</td>
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> 元/平米·月
    	</td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1"><font class="red">*</font> 建筑面积</td>
    <td align="left" valign="middle" class="p25 grzc_33"><input name="" type="text"  value="" /> 平方米</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25">
    	<label><input id="" name="radio" type="radio" value="可分割" checked="checked" /> 可分割</label>     
      	<label> <input id="" name="radio" type="radio" value="不可分割" /> 不可分割</label>   </td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1">装修程度</td>
    <td align="left" valign="middle" class="p25">
    	<label><input id="" name="radio" type="radio" value="精装修" checked="checked" /> 精装修</label>     
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25" style="line-height:26px;">
    	 <label><input id="" name="radio" type="radio" value="甲级" checked="checked" /> 甲级</label>     
      	<label> <input id="" name="radio" type="radio" value="乙级" /> 乙级</label>
        <label> <input id="" name="radio" type="radio" value="丙级" /> 丙级</label>
        <label> <input id="" name="radio" type="radio" value="其它" /> 其它</label>
    </td>
  </tr>
</table>
