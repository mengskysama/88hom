	...
	<div class="qg_tb1">
        ...
        <div class="qg_ssk">
			...
			<div class="qg_ssk3">
                        ...
                        <span class="qg_zf"><img src="images/qg_16.jpg"><a href="#">[地图找房]</a></span>
                        <span class="qg_zf"><img src="images/qg_19.jpg"><a href="#">[地铁找房]</a></span>
</div>
        </div>
    </div>
            </div>
...
<div class="qg_main">
	<div class="qg_l">
        ...
        <div class="qg_zc">
          ...
          <dl>
          	    ...
          	    <dd class="qg_bt2"><a href="#">我要出售</a></dd>
  ...
  <div class="qg_r">
    <p>你的位置: <a href="#">房源管理</a></p>
   	<div class="qg_bs">
 		   <ul>
   			 	<li><a href="#">录入住宅出售房源</a></li>
    		    <li><a href="#">录入别墅出售房源</a></li>
     		    <li><a href="#">录入商铺出售房源</a></li>
      		 	<li><a href="#">录入写字楼出售房源</a></li>
       		    <li><a href="#">录入厂房出售房源</a></li>
   		  </ul>
      <div class="bs_tx">
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25"><select name="ddlProv" id="ddlProv"><option selected="selected" value="0">请选择县区</option></select> <select name="ddlProv" id="ddlProv"><option selected="selected" value="0">请选择商圈</option></select></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25">
    	 <label><input id="" name="radio" type="radio" value="独立厂房" checked="checked" /> 独立厂房</label>     
      	<label> <input id="" name="radio" type="radio" value="工业园" /> 工业园  </label>    
        <label><input id="" name="radio" type="radio" value="开发区" /> 开发区</label>    
        <label><input id="" name="radio" type="radio" value="产业基地" /> 产业基地</label>  
        <label><input id="" name="radio" type="radio" value="其他" /> 其他</label>
    </td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1"><font class="red">*</font>  售    价</td>
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> <font class="z3">元/平米</font></td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1"><font class="red">*</font> 管 理 费</td>
    <td align="left" valign="middle" class="p25 grzc_32"><input name="input" type="text"  value="" /> 
      <font class="z3">元/平米·月</font> </td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1">管理单位</td>
    <td align="left" valign="middle" class="p25 grzc_31"><input name="" type="text"  value="" /></td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1">土地证</td>
    <td align="left" valign="middle" class="p25">
    	<label><input id="" name="radio" type="radio" value="国有土地证" checked="checked" /> 国有土地证</label>     
      	<label> <input id="" name="radio" type="radio" value="集体土地证" /> 集体土地证  </label>    
    </td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1">占地面积</td>
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> 
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> <font class="z3">平方米</font></td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1">车间面积</td>
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> <font class="z3">平方米</font>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> <font class="z3">年</font>   
    </td>
  </tr>
   <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1">跨    度</td>
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /><font class="z3"> 米</font>  
    </td>
  </tr>
   <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1">层    数</td>
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> <font class="z3">层</font> 
    </td>
  </tr>
   <tr>
   ...
   <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> <font class="z3">吨/平米</font>   
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_32"><input name="" type="text"  value="" /> <font class="z3">KVA</font>       
    </td>
  </tr><tr>
