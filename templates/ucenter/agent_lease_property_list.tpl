...
<div style="width:700px; border-bottom:1px solid #ddd">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
			    ...
			    <input id="propPriceFrom" name="propPriceFrom" type="text" value="<!--{$propPriceFrom}-->" />—<input id="propPriceTo" name="propPriceTo" type="text" value="<!--{$propPriceTo}-->" />元/月</td>
			  ...
			  <tr>
			    ...
			    <td width="225" align="left" valign="middle" class="bor">
			        ...
			        <span class="l wz">
						...
						户型：<!--{$propList[prop].room}-->室<!--{$propList[prop].hall}-->厅 <br />
					 	<!--{/if}-->
			    ...
			    <a href="agent_lease_zz_edit.php?propId=<!--{$propList[prop].propId}-->">编辑</a>
			    <!--{elseif $propList[prop].propKind eq 'bs'}-->
			    <a href="agent_lease_bs_edit.php?propId=<!--{$propList[prop].propId}-->">编辑</a>
			    <!--{elseif $propList[prop].propKind eq 'sp'}-->
			    <a href="agent_lease_sp_edit.php?propId=<!--{$propList[prop].propId}-->">编辑</a>
