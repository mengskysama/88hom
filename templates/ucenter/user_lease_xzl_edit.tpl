...
<div class="qg_main">
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_33"><input id="officeNumber" name="officeNumber" type="text" value="<!--{$officeNumber}-->" maxlength="12" />  </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <input id="officeRentPrice" name="officeRentPrice" type="text" value="<!--{$officeRentPrice}-->"/>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="p25 grzc_32"><input id="officeProFee" name="officeProFee" type="text" value="<!--{$officeProFee}-->" /> 元/平米·月
			  ...
			  <tr>
			    ...
			    <input id="officePayment" checked="checked" name="officePayment" type="radio" value="1" <!--{if $officePayment eq 1 }--> checked="checked" <!--{/if}--> onclick="changeShopPaydetail()"/>押&nbsp;
				...
				<option value="1" <!--{if $officePayDetailY eq 1 }--> selected="selected" <!--{/if}-->>一个月</option>
				<option value="2" <!--{if $officePayDetailY eq 2 }--> selected="selected" <!--{/if}-->>两个月</option>
				<option value="3" <!--{if $officePayDetailY eq 3 }--> selected="selected" <!--{/if}-->>三个月</option>
				<option value="6" <!--{if $officePayDetailY eq 6 }--> selected="selected" <!--{/if}-->>六个月</option>
				</select>
                                                       付&nbsp;
				<select name="officePayDetailF" id="officePayDetailF" style=" vertical-align:middle">
                                    <option selected="selected" value="">请选择</option>
                                    <option value="1" <!--{if $officePayDetailF eq 1 }--> selected="selected" <!--{/if}-->>一个月</option>
                                    <option value="2" <!--{if $officePayDetailF eq 2 }--> selected="selected" <!--{/if}-->>两个月</option>
                                    <option value="3" <!--{if $officePayDetailF eq 3 }--> selected="selected" <!--{/if}-->>三个月</option>
			    ...
			    <input id="officePayment" name="officePayment" type="radio" value="2" <!--{if $officePayment eq 2 }--> checked="checked" <!--{/if}--> onclick="changeShopPaydetail();" />面议
				</td>
			  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1"><font class="red">*</font> 建筑面积</td>
    <td align="left" valign="middle" class="p25 grzc_33"><input id="officeBuildArea" name="officeBuildArea" type="text" value="<!--{$officeBuildArea}-->" maxlength="8" /> 平方米</td>
  </tr>
  <tr>
    <td width="120" height="36" align="center" valign="middle" bgcolor="#f7f6f1"><font class="red">*</font> 楼    层</td>
    <td align="left" valign="middle" class="p25 grzc_35"><font class="z3">第</font> <input id="officeFloor" name="officeFloor" type="text" value="<!--{$officeFloor}-->" /> <font class="z3">层</font>   <font class="z3">共</font> <input id="officeAllFloor" name="officeAllFloor" type="text" value="<!--{$officeAllFloor}-->" /> <font class="z3">层</font> 地下室请填写负数</td>
  </tr>
  <tr>
            ...
            <table width="90%" border="0" cellspacing="1" cellpadding="0" bordercolor="#FFFFFF">
			  ...
			  <tr>
			    ...
			    <td colspan="2" align="left" valign="middle" class="p25 grzc_31">
			    	<input id="officeTitle" name="officeTitle" type="text" value="<!--{$officeTitle}-->" maxlength="60" onkeyup="textCounter(document.getElementById('officeTitle'),document.getElementById('officeTitleAlert'),30);" /> 还可写<span id="officeTitleAlert"><font class="red">30</font></span>个汉字</td>
			  </tr>
			  <tr>
